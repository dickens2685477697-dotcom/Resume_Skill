---
name: resume-tailor
description: 面向定向求职的简历证据管理与生成 Skill。读取用户提供的简历、项目经历、作品集、研究材料和目标岗位 JD，建立可追溯的个人经历库，检查 STAR 与业务证据缺口，完成 JD 分析、经历匹配、项目筛选、简历改写、事实审计和面试问题预测。适用于“根据 JD 修改简历”“选择最相关项目”“补全项目经历”“生成一页简历”“分析岗位匹配度”“resume tailoring”“JD matching”等任务。不用于脱离用户真实材料的虚构简历、批量自动投递或仅提供泛化职业建议。
---
